...
class BroadcastTemplateStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'contact_group_id' => 'required_if:whats_app_group_name,'.null.'|integer|min:1|exists:groups,id,user_id,'.auth()->user()->id,
            'whats_app_group_name' => 'required_if:contact_group_id,'.null.'|string|min:1',
    ...
    public function messages()
    {
        return [
            ...
            'contact_group_id.required_if' => 'A contact group id is required if there is no whatsapp group name',
            ...
            'whats_app_group_name.required_if' => 'A whats app group name is required if there is no contact group id',
